...
const Content = () => {
  return (
    <div id="about" className="w-full h-screen h-3/4 flex-center flex-col items-center">
      <div className="flex items-center">
        <div className="ml-14 p-14">
          <Image src="/images/kaneki.jpg" alt="image" width={700} height={400} />
        </div>
        <p className="text-2xl">Welcome to <span className="text-orange-500">Apex</span> Blog<br/>
